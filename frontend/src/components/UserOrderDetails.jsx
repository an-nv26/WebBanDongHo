    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      <div className="w-full flex items-center justify-between pt-6">
        <h5 className="text-[#00000084]">
          Mã đặt hàng: <span>#{data?._id?.slice(0, 8)}</span>
        </h5>
        <h5 className="text-[#00000084]">
      ...
      {data &&
        data?.cart.map((item, index) => {
          ...
          <div className="w-full flex items-start mb-5">
            ...
            {!item.isReviewed && data?.status === "Vận chuyển" ?  <div
            ...
            <div className="w-full flex">
              ...
              <div>
                ...
                <h4 className="pl-3 text-[20px]">
                  {convertDollarsToVnd(selectedItem?.discountPrice)} x {selectedItem?.qty} VNĐ
                </h4>
              </div>
            </div>
      ...
      <div className="border-t w-full text-right">
        <h5 className="pt-3 text-[18px]">
          Tổng tiền: <strong>{convertDollarsToVnd(data?.totalPrice)} VNĐ</strong>
        </h5>
      </div>
      <br />
      <br />
