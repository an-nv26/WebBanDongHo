  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      <div className="flex justify-between">
        ...
        <h5 className="text-[18px] font-[600]">{convertDollarsToVnd(subTotalPrice)} vnđ</h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Phí giao hàng:</h3>
        <h5 className="text-[18px] font-[600]">{convertDollarsToVnd(shipping.toFixed(2))} vnđ</h5>
      </div>
      <br />
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Mã giảm giá:</h3>
        <h5 className="text-[18px] font-[600]">
        {0} {convertDollarsToVnd(discountPercentenge) ? "vnđ" : null}
        </h5>
      </div>
      <h5 className="text-[18px] font-[600] text-end pt-3">{convertDollarsToVnd(totalPrice)} vnđ</h5>
      <br />
